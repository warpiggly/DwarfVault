...
enanoGif.addEventListener('mouseover', function() {
    ...
    const randomGif = Math.random() < 0.5 ? '../../assets/icons/Final Gif 2.gif' : '../../assets/icons/Final Gif 3.gif';
...
enanoGif.addEventListener('mouseout', function() {
    enanoGif.src = '../../assets/icons/Final Gif.gif'; // Vuelve al GIF original
});